...
equation
  ...
  connect(reaToInt.y, doe2Rev.uMod) annotation (Line(points={{17,0},{32,0},{32,
          -0.2},{45,-0.2}}, color={255,127,0}));
  connect(sine.y, doe2Rev.Q_flow_set)
    annotation (Line(points={{21,80},{40,80},{40,9},{45,9}}, color={0,0,127}));
  connect(mLoa_flow.y, doe2Rev.mLoa_flow)
    annotation (Line(points={{2,50},{34,50},{34,6},{45,6}}, color={0,0,127}));
  connect(mSou_flow.y, doe2Rev.mSou_flow) annotation (Line(points={{2,-50},{36,
          -50},{36,-8},{45,-8}}, color={0,0,127}));
  connect(TSouEnt.y, doe2Rev.TSouEnt) annotation (Line(points={{-40,-32},{30,-32},
