...
equation
  ...
  annotation (Line(points={{1,-30},{22,-30},{22,-9},{36.1667,-9}}, color={0,0,127}));
  ...
  annotation (Line(points={{-85,66},{-62,66}}, color={0,0,127}));
  ...
  connect(heaPum.port_b2, res2.port_a) annotation (Line(points={{37.3333,-6},
          {32,-6},{32,-70},{26,-70}},color={0,127,255}));
  connect(TEvaEnt.y, evaPum.T_in) annotation (Line(points={{81,-70},{112,-70},
          {112,-24},{98,-24}}, color={0,0,127}));
