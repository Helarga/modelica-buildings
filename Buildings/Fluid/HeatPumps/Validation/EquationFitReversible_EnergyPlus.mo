...
model EquationFitReversible_EnergyPlus "Validation with EnergyPlus model"
  ...
  Modelica.Blocks.Math.UnitConversions.From_degC TSetHea
    "Block that converts set point heating water temperature "
...
equation
  ...
  connect(TSetHea.y, heaPum.TSet) annotation (Line(points={{-39,40},{20,40},{20,
