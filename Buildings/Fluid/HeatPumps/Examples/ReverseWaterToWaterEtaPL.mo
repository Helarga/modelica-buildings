...
model ReverseWaterToWaterEtaPL
  "Test model of the water to water heatpump using the part load efficiency curve"
 package Medium = Buildings.Media.Water "Medium model";
    ...
    duration(displayUnit="h") = 14400,
    offset=6 + 273.15,
    startTime=0) if   reverseCycle "Cooling load setpoint water temperature"
...
equation
  ...
  annotation (Line(points={{-2,-70},{22,-70},{22,-6},{30,-6}},
                  color={0,127,255}));
  ...
  annotation (Line(points={{-27,0},{29,0}},
                  color={255,127,0}));
  connect(loaPum.T_in,TLoaEnt. y)
  annotation (Line(points={{-44,66},{-72,66}},
                  color={0,0,127}));
  connect(THeaLoaSet.y, heaPum.THeaLoaSet)
  annotation (Line(points={{2,30},{10,30},{10,9},{28.6,9}},
                               color={0,0,127}));
  connect(TCooSet.y, heaPum.TCooLoaSet) annotation (Line(points={{2,-28},{12,-28},
          {12,-9},{28.6,-9}},         color={0,0,127}));
