...
model AbsorptionIndirectSteamSwitchableRecords
  ...
  Buildings.Fluid.Chillers.AbsorptionIndirectSteamSwitchableRecords absIndSte(
    per( QEva_flow_nominal=-10000,
         P_nominal=150,
         PLRMax=1,
         PLRMin=0.15,
  ...
  Buildings.Fluid.Sources.MassFlowSource_T conPum(
    ...
    use_m_flow_in=false,
    m_flow=absIndSte.per.mCon_flow_nominal,
    use_T_in=true,
    nPorts=1)
  ...
  Buildings.Fluid.Sources.MassFlowSource_T evaPum(
    redeclare package Medium = Medium,
    m_flow=absIndSte.per.mEva_flow_nominal,
    use_T_in=true,
    nPorts=1)
