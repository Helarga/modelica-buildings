...
equation
  connect(port_a1, preDro1.port_a) annotation (Line(points={{-100,80},{-82,80},
          {-82,90},{-64,90}}, color={0,127,255}));
  connect(preDro1.port_b, vol1.ports[1])
    annotation (Line(points={{-44,90},{-2,90},{-2,80}}, color={0,127,255}));
  connect(vol1.ports[2], port_b1) annotation (Line(points={{2,80},{2,80},{2,90},
          {80,90},{80,80},{100,80}}, color={0,127,255}));
  connect(port_a2, preDro2.port_a)
    annotation (Line(points={{100,0},{68,0}}, color={0,127,255}));
  connect(vol2.ports[1], preDro2.port_b)
    annotation (Line(points={{-2,0},{48,0}}, color={0,127,255}));
  ...
  connect(vol3.ports[1], preDro3.port_a) annotation (Line(points={{-2,-70},{2,
          -70},{2,-80},{50,-80},{50,-80}}, color={0,127,255}));
  connect(vol3.ports[2], port_b3) annotation (Line(points={{2,-70},{-2,-70},{-2,
