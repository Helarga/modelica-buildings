...
model PlantIndirectETS "District cooling plant model"
  ...
  DataCenters.ChillerCooled.Equipment.FlowMachine_m                        pumCHW(
    redeclare package Medium = Medium,
  ...
  Modelica.Blocks.Math.Gain mChW[numChi](k=mCHW_flow_nominal)
    "Specific heat multiplier to calculate heat flow rate"
    annotation (Placement(transformation(extent={{-36,56},{-26,66}})));
protected
...
equation
  ...
  connect(chiOn.y, mulChiSys.on) annotation (Line(points={{-59,60},{-54,60},{
          -54,32},{22,32},{22,6},{12,6}},
                                      color={255,0,255}));
  ...
  connect(chiOn[1].y, bypValCon.trigger) annotation (Line(points={{-59,60},{-54,
          60},{-54,32},{40,32},{40,-16},{138,-16},{138,-12}}, color={255,0,255}));
  connect(mSetSca_flow.y, bypValCon.u_s) annotation (Line(points={{111,20},{150,
          20},{150,0},{142,0}}, color={0,0,127}));
  connect(chiStaCon.y, mChW.u) annotation (Line(points={{-99,56},{-90,56},{-90,
          30},{-48,30},{-48,61},{-37,61}}, color={0,0,127}));
  connect(mChW.y, pumCHW.u) annotation (Line(points={{-25.5,61},{22,61},{22,54},
          {12,54}}, color={0,0,127}));
