...
model IndirectCoolingEts "Indirect heating ETS."
 ...
 parameter Buildings.Fluid.Movers.Data.Generic perHWPum(
  ...
  EnergyTransferStations.CoolingIndirect         heaETS(
    redeclare package Medium = Medium,
    mDis_flow_nominal=0.8,
    mBui_flow_nominal=1,
    ...
    T_a2_nominal(displayUnit="degC") = 287.15,
    eta=0.8,
  ...
  Modelica.Blocks.Sources.RealExpression Tset(y=7 + 273.15)
