...
model HeatingWaterPumpSpeedTry
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput reSet annotation (
      Placement(transformation(extent={{-120,-38},{-100,-18}}),
...
equation
  ...
  connect(reSet, conPID.trigger) annotation (Line(points={{-110,-28},{-58,-28},
