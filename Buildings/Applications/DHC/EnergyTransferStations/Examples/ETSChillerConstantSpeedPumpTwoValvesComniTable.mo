...
model ETSChillerConstantSpeedPumpTwoValvesComniTable
  ...
  Modelica.Blocks.Sources.CombiTimeTable datRea(
    ...
    fileName=ModelicaServices.ExternalReferences.loadResource(
        "modelica://Buildings/Resources/Data/Applications/EnergyTransferStations/Examples/modelica.csv"),
    columns=2:6,
    tableName="modelica",
    smoothness=Modelica.Blocks.Types.Smoothness.ConstantSegments)
    "Reader for resedential heating and cooling load profiles."
      annotation (Placement(transformation(extent={{-114,-68},{-94,-48}})));

equation
  connect(TDisEnt.y, disPum.T_in)
  annotation (Line(points={{-44,-92},{-40,-92},{-40,-100},{-38,-100}},
                                                  color={0,0,127}));
...
end ETSChillerConstantSpeedPumpTwoValvesComniTable;
