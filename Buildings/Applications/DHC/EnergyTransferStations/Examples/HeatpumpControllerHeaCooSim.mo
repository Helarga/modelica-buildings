...
model HeatpumpControllerHeaCooSim
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Sine TConEnt_Input(
    amplitude=0.1,
    freqHz=1/3000,
    offset=40 + 273.15) "Load heat exchanger entering water temperature"
  ...
  Fluid.Sensors.MassFlowRate priHeaFlo(redeclare package Medium = Media.Water)
    "Primary circuit condenser side heating water flow rate" annotation (
      Placement(transformation(
        ...
        origin={148,-2})));
equation
  connect(mConEnt.T_in, TConEnt_Input.y)
  ...
  connect(TEvaLvg.T,heaPumCon.TEvaLvg)  annotation (Line(
      points={{9,-48},{9,-49},{-44,-49},{-44,-8.56},{-35,-8.56}},
      color={0,0,127},
  ...
  connect(heaPumCon.TConEnt, TConEnt.T) annotation (Line(
      points={{-35,-9.82},{-38,-9.82},{-38,-44},{-4,-44},{-4,6},{-9,6},{-9,54}},
      color={0,0,127},
      pattern=LinePattern.Dot));
  ...
  connect(splVal2.port_3, valEva.port_3) annotation (Line(points={{74,-78},{114,
          -78},{114,-12}}, color={0,127,255}));
  connect(heaPumCon.yValEva, valEva.y) annotation (Line(points={{-12.6,-3.16},{10,
          -3.16},{10,24},{114,24},{114,10}}, color={0,0,127}));
  connect(heaPum.port_b2, TEvaLvg.port_a)
    annotation (Line(points={{20,-6},{20,-38}}, color={0,127,255}));
  connect(TEvaLvg.port_b, splVal2.port_1) annotation (Line(points={{20,-58},{20,
          -64},{64,-64},{64,-68}}, color={0,127,255}));
  connect(splVal2.port_2, sin.ports[1])
    annotation (Line(points={{64,-88},{64,-116},{8,-116}}, color={0,127,255}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},
    ...
    __Dymola_Commands(
  file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DHC/EnergyTransferStations/Control/HeatpumpControllerHeaCooSim.mos"
        "Simulate and plot"),
         experiment(Tolerance=1e-6, StopTime=14400));
end HeatpumpControllerHeaCooSim;
