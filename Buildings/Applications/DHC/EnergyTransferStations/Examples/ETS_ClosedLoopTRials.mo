...
model ETS_ClosedLoopTRials
  ...
  BaseClasses.Constants mulCon(
    k={28 + 273.15,10 + 273.15,5 + 273.15,12 + 273.15,17 + 273.15,40 + 273.15},
...
equation
  ...
  connect(ETS.hotWatSup, pre.ports[1]) annotation (Line(points={{11,52.8},{32,52.8},
   ...
   annotation (Dialog(tab="Borefield"),
        ...
        Text(
          extent={{120,-20},{160,-40}},
          lineColor={238,46,47},
          textString="Heating Side"),
        Text(
          extent={{-158,-20},{-120,-40}},
        ...
        Text(
          ...
          textString="District Side")}),
              __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DHC/EnergyTransferStations/Examples/ETS_ClosedLoopTRials.mos"
                  "Simulate and plot"),
                  experiment(
      StopTime=18000,
      Tolerance=1e-06,
      __Dymola_Algorithm="Cvode"));
end ETS_ClosedLoopTRials;
