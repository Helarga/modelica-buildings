...
model AmbientSupplyHeader
  "Ambient water header to link between the borefield and distrcit system and the building loads"
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
        ...
        coordinateSystem(preserveAspectRatio=false)),defaultComponentName="ambSupHed");
end AmbientSupplyHeader;
