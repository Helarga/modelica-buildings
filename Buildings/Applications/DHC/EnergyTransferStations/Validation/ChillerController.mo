...
equation
  ...
  connect(chiCon.reqCoo, cooMod.y) annotation (Line(points={{38.6,-24.6},{-2,
          -24.6},{-2,0},{-19,0}},
                            color={255,0,255}));
  connect(cons.y[1], chiCon.TSetCoo) annotation (Line(points={{-19,-30},{-16,
          -30},{-16,-27},{39,-27}}, color={0,0,127}));
  connect(chiCon.TSetHea, cons.y[2]) annotation (Line(points={{39,-29},{-16,-29},
          {-16,-30},{-19,-30}}, color={0,0,127}));
  connect(cons.y[3], chiCon.TSetCooMin) annotation (Line(points={{-19,-30},{38,
          -30},{38,-31.2},{39,-31.2}}, color={0,0,127}));
  connect(cons.y[5], chiCon.TMaxEvaEnt) annotation (Line(points={{-19,-30},{-16,
          -30},{-16,-34.6},{39,-34.6}}, color={0,0,127}));
  connect(cons.y[6], chiCon.TEvaEnt) annotation (Line(points={{-19,-30},{-16,
          -30},{-16,-36.6},{39,-36.6}}, color={0,0,127}));
  connect(cons.y[7], chiCon.TConLvg) annotation (Line(points={{-19,-30},{-16,
          -30},{-16,-38.4},{39,-38.4}}, color={0,0,127}));
  connect(cons.y[8], chiCon.TConEnt) annotation (Line(points={{-19,-30},{-16,
          -30},{-16,-39.8},{39,-39.8}}, color={0,0,127}));
  connect(cons.y[4], chiCon.TMinConEnt) annotation (Line(points={{-19,-30},{-16,
          -30},{-16,-32.8},{39,-32.8}}, color={0,0,127}));
