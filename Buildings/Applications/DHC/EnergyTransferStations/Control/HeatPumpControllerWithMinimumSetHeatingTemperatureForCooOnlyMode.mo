...
model HeatPumpControllerWithMinimumSetHeatingTemperatureForCooOnlyMode
  "The control block of the heatpump on heating mode"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.IntegerOutput yHeaPumMod
    "Heatpump operational mode" annotation (Placement(transformation(extent={{102,42},
...
end HeatPumpControllerWithMinimumSetHeatingTemperatureForCooOnlyMode;
