...
model AmbientCircuitSid "Generate control outputs for source model"
  ...
  Modelica.Blocks.Interfaces.RealInput TBorEnt(final unit="K")
    "Borefield entering water temperature " annotation (Placement(
        transformation(extent={{-260,-68},{-220,-28}}), iconTransformation(
          extent={{-120,-108},{-100,-88}})));
  ...
  Modelica.Blocks.Interfaces.IntegerOutput yModInd "Mode index"
    annotation (Placement(transformation(extent={{220,-238},{240,-218}}),
  ...
  Buildings.Controls.OBC.CDL.Logical.Switch modInd "Mode index"
  ...
  Buildings.Controls.OBC.CDL.Logical.Or3 runHex
    ...
    annotation (Placement(transformation(extent={{-180,-232},{-160,-212}})));
  ...
  Buildings.Controls.OBC.CDL.Logical.MultiAnd opeHea(nu=2)
    "Operate to deliver heat and reject from tank"
    annotation (Placement(transformation(extent={{-120,180},{-100,200}})));
  Buildings.Controls.OBC.CDL.Logical.MultiAnd opeCol(nu=2)
    "Operate to deliver cold and reject from tank"
  ...
  Buildings.Controls.OBC.CDL.Logical.And runHexOnly
    "Output true if we need to provide heating or cooling, but the borefield is not operating"
  ...
  Buildings.Controls.OBC.CDL.Logical.Switch modInd1 "Mode index"
    annotation (Placement(transformation(extent={{160,-168},{180,-148}})));
  Buildings.Controls.OBC.CDL.Logical.Switch modInd2 "Mode index"
    annotation (Placement(transformation(extent={{120,-238},{140,-218}})));
...
equation
  ...
  connect(reaToInt.y, yModInd)
    annotation (Line(points={{202,-228},{230,-228}},
                                                   color={255,127,0}));
  ...
  connect(runHex.y, noHex.u)
    annotation (Line(points={{-158,-222},{-100,-222},{-100,-292},{-62,-292}},
                                                       color={255,0,255}));
  ...
  connect(hexPumConOut.u2,runHex. y) annotation (Line(points={{98,-276},{80,
          -276},{80,-222},{-158,-222}}, color={255,0,255}));
  connect(not1.y, runHexOnly.u2) annotation (Line(points={{102,152},{118,152}},
                               color={255,0,255}));
  connect(or3.y, not1.u) annotation (Line(points={{-18,90},{60,90},{60,152},{78,
          152}},                         color={255,0,255}));
  connect(runHex.u1, runHexOnly.y) annotation (Line(points={{-182,-214},{-192,
  ...
  connect(or3.u2, opeCol.y) annotation (Line(points={{-42,82},{-80,82},{-80,160},
          {-98,160}},  color={255,0,255}));
  connect(runHexOnly.u1, valOpe.y) annotation (Line(points={{118,160},{108,160},
          {108,240},{-158,240}}, color={255,0,255}));
  ...
  connect(cooModInd.y, modInd1.u3) annotation (Line(points={{104,-178},{150,
          -178},{150,-166},{158,-166}},
                                color={0,0,127}));
  connect(modInd2.u2, runHex.y)
    annotation (Line(points={{118,-228},{-20,-228},{-20,-222},{-158,-222}},
                                                      color={255,0,255}));
  connect(modInd1.y, modInd2.u1) annotation (Line(points={{182,-158},{200,-158},
          {200,-198},{100,-198},{100,-220},{118,-220}},
                                                     color={0,0,127}));
  connect(modInd2.u3, con4.y) annotation (Line(points={{118,-236},{60,-236},{60,
          -198},{42,-198}},
                          color={0,0,127}));
  connect(reaToInt.u, modInd2.y) annotation (Line(points={{178,-228},{142,-228}},
                                  color={0,0,127}));
  connect(TDisHexEnt, add1.u2) annotation (Line(points={{-240,-282},{-140,-282},
          {-140,-88},{-42,-88}}, color={0,0,127}));
  connect(TBorEnt, add1.u1) annotation (Line(points={{-240,-48},{-140,-48},{
          -140,-76},{-42,-76}}, color={0,0,127}));
