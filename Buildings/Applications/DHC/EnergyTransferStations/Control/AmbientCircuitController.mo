...
model AmbientCircuitController
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant con3(k=dTHex)
    "Difference between the district heat exchnager leaving and entering water temperature(+ve)."
  ...
  Modelica.Blocks.Interfaces.RealInput TBorLvg(final unit="K")
    "Borefield leaving water temperature " annotation (Placement(transformation(
