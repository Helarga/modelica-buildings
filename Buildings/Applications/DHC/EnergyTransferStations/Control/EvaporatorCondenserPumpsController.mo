...
model EvaporatorCondenserPumpsController
  ...
  Buildings.Controls.Continuous.LimPID pumCon(
    ...
    y_reset=0.1,
    k=1,
    Ti(displayUnit="s") = 300) "Controller for controller pump speed"
  ...
  Buildings.Controls.Continuous.LimPID pumEva(
    ...
    y_reset=0.1,
    k=1,
    Ti(displayUnit="s") = 300) "Controller for evaporator pump speed"
...
equation
  ...
  connect(ReqCoo, or2.u2) annotation (Line(points={{-114,14},{-78,14},{-78,22},{
  ...
  connect(or2.y, swi1.u2) annotation (Line(points={{-18,30},{118,30}},
                color={255,0,255}));
  connect(max2.y, swi1.u1) annotation (Line(points={{82,130},{88,130},{88,38},{118,38}},
                     color={0,0,127}));
  ...
  connect(pro.y, max.u1) annotation (Line(points={{-46,90},{-44,90},{-44,130},{
  ...
  connect(pumEva.y, max2.u1) annotation (Line(points={{45,-42},{54,-42},{54,124},
          {58,124}}, color={0,0,127}));
  connect(pumCon.y, max2.u2) annotation (Line(points={{29,136},{58,136}},
                     color={0,0,127}));
  connect(swi1.y,yPumCon)  annotation (Line(points={{142,30},{158,30},{158,160},{216,160}},
        color={0,0,127}));
  connect(swi1.y,yPumEva)  annotation (Line(points={{142,30},{158,30},{158,-80},{216,-80}},
        color={0,0,127}));
