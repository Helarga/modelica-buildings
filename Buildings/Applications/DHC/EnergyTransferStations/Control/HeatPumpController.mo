...
model HeatPumpController "The control block of the heatpump on heating mode"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput           heaPumMod
  "Heatpump operational mode"
   annotation (Placement(transformation(extent={{100,28},{120,48}}),
        iconTransformation(extent={{100,64},{128,92}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput TSetCon
    "Setpint temperture for the heatpump" annotation (Placement(transformation(
          extent={{100,-52},{120,-32}}), iconTransformation(extent={{100,-14},{
            128,14}})));
...
equation
  ...
  connect(ReqHea, or1.u1) annotation (Line(points={{-114,68},{-62,68},{-62,38},
          {-42,38}}, color={255,0,255}));
  connect(or1.y, swi1.u2)
    annotation (Line(points={{-19,38},{-2,38}}, color={255,0,255}));
  connect(swi1.u1, heaModHeaPum.y) annotation (Line(points={{-2,46},{-16,46},{
          -16,64},{-28,64}}, color={0,0,127}));
  connect(swi1.u3, shuOffSig.y) annotation (Line(points={{-2,30},{-16,30},{-16,
  ...
  connect(ReqCoo, swi3.u2) annotation (Line(points={{-114,30},{-96,30},{-96,-50},
          {32,-50}}, color={255,0,255}));
  connect(swi3.u3, MinSetTem.y) annotation (Line(points={{32,-58},{24,-58},{24,
          -156},{2,-156}}, color={0,0,127}));
  connect(swi3.y, swi2.u3) annotation (Line(points={{56,-50},{74,-50}},
                     color={0,0,127}));
  connect(swi2.y, TSetCon)
    annotation (Line(points={{98,-42},{110,-42}}, color={0,0,127}));
  connect(ReqCoo, and1.u2) annotation (Line(points={{-114,30},{-96,30},{-96,-28},
          {-54,-28}}, color={255,0,255}));
  connect(ReqHea, and1.u1) annotation (Line(points={{-114,68},{-92,68},{-92,-20},
          {-54,-20}}, color={255,0,255}));
  connect(ReqHea, or2.u1) annotation (Line(points={{-114,68},{-92,68},{-92,-4},
          {-16,-4},{-16,-20},{-10,-20}}, color={255,0,255}));
  connect(and1.y, or2.u2) annotation (Line(points={{-31,-20},{-26,-20},{-26,-28},
          {-10,-28}}, color={255,0,255}));
  connect(or2.y, swi2.u2) annotation (Line(points={{13,-20},{70,-20},{70,-42},{
          74,-42}}, color={255,0,255}));
  connect(pumConCon.u_s, TSetCoo)
    annotation (Line(points={{-82,-116},{-114,-116}}, color={0,0,127}));
  connect(TEvaLvg, pumConCon.u_m) annotation (Line(points={{-114,-148},{-70,
          -148},{-70,-128}}, color={0,0,127}));
  connect(pumConCon.y, product.u2) annotation (Line(points={{-59,-116},{-42,
          -116}},                       color={0,0,127}));
  connect(ReqCoo, pumConCon.trigger) annotation (Line(points={{-114,30},{-96,30},
          {-96,-140},{-78,-140},{-78,-128}}, color={255,0,255}));
  connect(TConLvg, add.u1) annotation (Line(points={{-114,-66},{-96,-66},{-96,
          -80},{-82,-80}}, color={0,0,127}));
  connect(TConEnt, add.u2)
    annotation (Line(points={{-114,-92},{-82,-92}}, color={0,0,127}));
  connect(add.y, product.u1) annotation (Line(points={{-59,-86},{-46,-86},{-46,
          -104},{-42,-104}}, color={0,0,127}));
  connect(TConLvg, add1.u1)
    annotation (Line(points={{-114,-66},{-10,-66}}, color={0,0,127}));
  connect(add1.y, swi3.u1) annotation (Line(points={{13,-72},{18,-72},{18,-42},
          {32,-42}}, color={0,0,127}));
  connect(product.y, add1.u2) annotation (Line(points={{-19,-110},{-16,-110},{
