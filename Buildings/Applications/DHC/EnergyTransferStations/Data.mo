...
package Data "Perfromance data"
  ...
  //    "Pressure difference of heat exchanger";
    ...
    parameter Modelica.SIunits.PressureDifference dpBor_nominal(displayUnit="Pa")=1.3E5
     "Pressure drop borefield loop, without heat exchanger";
    ...
    annotation (
    defaultComponentName="datGeo", Documentation(info="<html>
<p>
