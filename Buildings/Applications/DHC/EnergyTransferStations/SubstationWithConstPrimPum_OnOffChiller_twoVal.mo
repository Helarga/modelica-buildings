...
model SubstationWithConstPrimPum_OnOffChiller_twoVal
...
//----------------------------Borefield system---------------------------------------
 ...
 //----------------------Fluid Interfaces and hydraluic headers----------------------
   //------Building cooling side connection------------------------------------------
    ...
    redeclare final package Medium = Medium,
    p(start=Medium.p_default))
      "Chilled watersupply to the building"
...
<ul>
<li>
The hot water circuit which has a hydraulic interface with the building heating requirments.
</li>
<li>
The chilled water circuit which has a hydraulic interface with the building cooling requirments.
</li>
<li>
...
<p>
For more detailed description for
</p>
<p>
...
first to the borefield system and second to either both the borfield and the district systems or only to the district system.
It consists of 
</p>
<ol>
<li>
The borfield holes componenet model <code>borFie</code>.
</li>
<li>
...
<li>
The heat exchanger componenet model <code>hex</code>.
</li>
<li>
...
which seperates the ambinet from the cold and hot water circuits.
</ol>
<p>
...
<ul>
<li>
First implementation by Hagar Elarga <br/>
</li>
</ul>
</html>"));
end SubstationWithConstPrimPum_OnOffChiller_twoVal;
