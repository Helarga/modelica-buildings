...
equation
  ...
  connect(bui.secHeaRet[1], sinHeaWat.ports[1]) annotation (Line(points={{60,
          -36},{100,-36},{100,0},{120,0}}, color={0,127,255}));
  connect(bui.secCooRet[1], sinChilWat.ports[1]) annotation (Line(points={{60,
          -33},{80,-33},{80,-60},{120,-60}}, color={0,127,255}));
  connect(bui.secCooSup[1], supChiWat.ports[1]) annotation (Line(points={{40,
          -32.9333},{20,-32.9333},{20,-60},{-20,-60}}, color={0,127,255}));
  annotation (
