...
model BuildingSpawnZ1 "One-zone EnergyPlus building model"
  import Buildings;
  extends Buildings.Applications.DHC.Loads.BaseClasses.PartialBuildinglbloLD(
...
equation
  ...
  connect(minTSet.y, terUni.TSetHea) annotation (Line(points={{-258,260},{-220,
          260},{-220,-45},{-160.833,-45}},
                                      color={0,0,127}));
  connect(disFloHea.port_b, ports_b[1]) annotation (Line(points={{-100,-110},{
          270,-110},{270,32},{300,32}}, color={0,127,255}));
  connect(secCooSup[1], disFloCoo.port_a) annotation (Line(points={{-300,-30},{
          -284,-30},{-284,-150},{-120,-150}},
                                         color={0,127,255}));
  connect(disFloCoo.port_b, secCooRet[1]) annotation (Line(points={{-100,-150},
          {282,-150},{282,-30},{300,-30}},color={0,127,255}));
  connect(disFloHea.port_a, ports_a[1]) annotation (Line(points={{-120,-110},{-260,
          -110},{-260,32},{-300,32}}, color={0,127,255}));
  annotation (
  Documentation(info="
<html>
<p>
