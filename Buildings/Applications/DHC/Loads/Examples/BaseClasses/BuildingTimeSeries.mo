...
equation
  ...
  connect(terUniHea.mReqHeaWat_flow, disFloHea.mReq_flow[1]) annotation (Line(
        points={{90.8333,-27.3333},{92,-27.3333},{92,-28},{100,-28},{100,-74},{
          119,-74}},
                 color={0,0,127}));
 ...
 if have_pum then
  ...
  connect(loa.y[2], terUniHea.QReqHea_flow) annotation (Line(points={{21,0},{46,
          0},{46,-25.6667},{69.1667,-25.6667}},
                                      color={0,0,127}));
  connect(maxTSet.y, terUniCoo.TSetCoo) annotation (Line(points={{-38,70},{48,
          70},{48,23.3333},{69.1667,23.3333}},
                                           color={0,0,127}));
  connect(minTSet.y, terUniHea.TSetHea) annotation (Line(points={{-38,30},{40,
          30},{40,-19},{69.1667,-19}},
                                 color={0,0,127}));
 ...
 if have_heaLoa then
  connect(disFloHea.port_a, secHeaSup[1]) annotation (Line(points={{120,-70},{-260,
          -70},{-260,32},{-300,32}}, color={0,127,255}));
  connect(disFloHea.port_b, secHeaRet[1]) annotation (Line(points={{140,-70},{220,
          -70},{220,32},{300,32}}, color={0,127,255}));
 end if;
 if have_cooLoa then
  connect(disFloCoo.port_b, secCooRet[1]) annotation (Line(points={{140,-110},{240,
          -110},{240,-30},{300,-30}}, color={0,127,255}));
  connect(disFloCoo.port_a, secCooSup[1]) annotation (Line(points={{120,-110},{-282,
          -110},{-282,-30},{-300,-30}}, color={0,127,255}));
 end if;
annotation (
