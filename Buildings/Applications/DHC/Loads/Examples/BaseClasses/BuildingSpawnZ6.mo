...
equation
  ...
  connect(terUni.mReqHeaWat_flow, disFloHea.mReq_flow) annotation (Line(points={{
          -119.167,5.33333},{-100,5.33333},{-100,-90.5},{-237,-90.5},{-237,-182}},
                                                        color={0,0,127}));
 ...
 if have_pum then
  connect(PPum, mulSum3.y) annotation (Line(points={{320,80},{302,80},{302,80},{282,80}},
                                                 color={0,0,127}));
  ...
  connect(znPerimeter_ZN_1.ports[1], terUni[3].port_aLoa) annotation (Line(points={{42,0.8},
          {-8,0.8},{-8,18.1667},{-120,18.1667}},    color={0,127,255}));
  connect(terUni[3].port_bLoa, znPerimeter_ZN_1.ports[2]) annotation (Line(points={{-140,
          18.1667},{-20,18.1667},{-20,0.8},{46,0.8}}, color={0,127,255}));
