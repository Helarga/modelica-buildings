...
equation
  ...
  connect(minTSet.y, terUni.TSetHea) annotation (Line(points={{-268,240},{-220,
          240},{-220,-45},{-200.833,-45}},
                                      color={0,0,127}));
  connect(disFloHea.port_b, secHeaRet[1]) annotation (Line(points={{-120,-90},{260,
          -90},{260,32},{300,32}}, color={0,127,255}));
  connect(secCooSup[1], disFloCoo.port_a) annotation (Line(points={{-300,-30},{-280,
          -30},{-280,-150},{-140,-150}}, color={0,127,255}));
  connect(disFloCoo.port_b, secCooRet[1]) annotation (Line(points={{-120,-150},{
          280,-150},{280,-30},{300,-30}}, color={0,127,255}));
  connect(disFloHea.port_a, secHeaSup[1]) annotation (Line(points={{-140,-90},{-260,
          -90},{-260,32},{-300,32}}, color={0,127,255}));
  connect(office.port_b, terUni[1].heaPorRad) annotation (Line(points={{-85,
          -20.2},{-85,-50},{-186.667,-50}}, color={191,0,0}));
  annotation (
  Documentation(info="
<html>
<p>
