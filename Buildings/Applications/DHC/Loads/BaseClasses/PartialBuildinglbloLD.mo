...
partial model PartialBuildinglbloLD "Partial class for building model"
  ...
  Modelica.Fluid.Interfaces.FluidPorts_b ports_b[nPorts_b](
    ...
    "Source side outlet ports" annotation (Placement(transformation(extent={{290,
            -42},{310,38}}), iconTransformation(extent={{290,-220},{310,-140}})));
...
initial equation
  assert(nPorts_a == nPorts_b,
    "In " + getInstanceName() +
    ": The numbers of secondary heating source side inlet ports (" + String(nPorts_a) +
