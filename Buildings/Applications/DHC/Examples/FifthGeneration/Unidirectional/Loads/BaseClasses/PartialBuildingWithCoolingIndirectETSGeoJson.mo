...
partial model PartialBuildingWithCoolingIndirectETSGeoJson
  ...
  replaceable Buildings.Applications.DHC.EnergyTransferStations.CoolingIndirect  ets
...
end PartialBuildingWithCoolingIndirectETSGeoJson;
