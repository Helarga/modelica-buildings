...
model BuildingSpawnZ6WithHeatingIndirectETS
  ...
  Buildings.Applications.DHC.EnergyTransferStations.Heating.HeatingIndirect ets(
  ...
  Modelica.Fluid.Sources.FixedBoundary preSou(redeclare package Medium =
        MediumW, nPorts=1)
